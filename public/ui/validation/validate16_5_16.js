...
function personal_info(){
    ...
    formData.append("spouse_lastname", spouse_lastname);
	...
	if(name=='' && spouse_name=='' && lastname=='' && spouse_lastname=='' && wedding_date=='' && email=='' && $('#male_image').val()=='' && $('#female_image').val()==''){

	  document.getElementById('name').style.borderColor='red';
	  document.getElementById('spouse_name').style.borderColor='red';
	  document.getElementById('last_name').style.borderColor='red';
	  document.getElementById('spouse_lastname').style.borderColor='red';
