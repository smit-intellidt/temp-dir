        ...
        <table>
            ...
            <tr>
             ...
             <tr class="customTH">
              ...
              <tr>
                    <th colspan="4" style="height: 20px; border:none">
                    </th>
                </tr>
                  ...
                  <th colspan="4" style="border:none">
                    <ul>
                          @foreach ($images as  $image) 
                            <li><p style="list-style: circle;">{{ $image }}</p></li>
                           @endforeach
                   </ul>
                  </th>
            </tr>
                    ...
                    <table style="width: 100%; border: none;">
                        ...
                        <tr>
                            ...
                            <td style="border: none; text-align: left;">
                                <div style="display: flex; flex-direction: column;">
                                    <div>
                                        <p><u>{{ !empty($initial_assistant_gm) ? $initial_assistant_gm : "" }}</u></p>
                                    </div>
                                    <div>
                                        <p><u>{{ !empty($initial_gm) ? $initial_gm : "" }}</u></p>
                                    </div>
                                    <div>
                                        <p><u>{{ !empty($initial_risk_mng_committee) ? $initial_risk_mng_committee : "" }}</u></p>
                                    </div>
                                    <div>
                                        <p>{{ !empty($initial_other) ? $initial_other : "" }}</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
