...
<ol class="breadcrumb breadcrumb-quirk">
    ...
    <li class="active">Unpublish Article List</li>
</ol>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel article_container">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped-col data_table_list" data-url="{{ url('unpublished-article-list') }}" data-page-size="{{ config('constants.pagination_limit') }}" data-ordering="true">
                        <thead>
                            <tr>
                                ...
                                <th data-column="publish_date" data-order="true" width="10%">Publish Date</th>
